...
//        context.startActivity(intent);
    ...
    public static boolean verify(File apk, String md5) {
        ...
        String _md5 = Md5Util.getFileMd5(apk);
    ...
    public static String getFilePath(Context context) {
        File apk = new File(context.getExternalCacheDir(), File.separator + "download" + File.separator + "appdsn_v" + getAppVersionName(context) + ".apk");
    ...
    public static String getTempPath(Context context) {
        File apk = new File(context.getExternalCacheDir(), File.separator + "download" + File.separator + "appdsn_v" + getAppVersionName(context));
        return apk.getAbsolutePath();
    }

    public static File makeFile(Context context) {
        File file = new File(context.getExternalCacheDir(), File.separator + "download");
        return new File(file, "appdsn_v" + getAppVersionName(context) + ".apk");
    }

    public static File makeFile(Context context, boolean haveMd5String) {
        File file = new File(context.getExternalCacheDir(), File.separator + "download");
        if (!file.exists()) {
            file.mkdirs();
        }

        File newFile = new File(file, "appdsn_v" + getAppVersionName(context));
        if (newFile.exists() && !haveMd5String) {
            newFile.delete();
        }
        return new File(file, "appdsn_v" + getAppVersionName(context) + ".apk");
    }
