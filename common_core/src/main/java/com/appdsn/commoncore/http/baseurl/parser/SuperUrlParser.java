...
import static com.appdsn.commoncore.http.baseurl.BaseUrlManager.IDENTIFICATION_PATH_SIZE;
 ...
 * 使用您传入 {@link BaseUrlManager#putDomain(String, String)} 方法的 Url 替换掉
 ...
 * 使 BaseUrlManager 可以从容应对各种复杂的需求
 * <p>
 * 超级模式也需要手动开启, 但与高级模式不同的是, 开启超级模式并不需要调用 API, 只需要在 Url 中加入 {@link BaseUrlManager#IDENTIFICATION_PATH_SIZE} + PathSize
 * <p>
 * 替换规则如下:
 * 1.
