package com.appdsn.commoncore.widget.countdown;
...
public class CountdownButton extends AppCompatButton implements View.OnClickListener {
     ...
     * @param beforeText
     */
    public void setBeforeText(String beforeText, int color) {
        this.beforeText = beforeText;
        this.beforeTextColor = color;
     ...
     * @param beforeText
     */
    public void setAfterText(String beforeText, int color) {
        this.afterText = afterText;
        this.afterTextColor = color;
    }
    ...
    public void start() {
        ...
        this.setTextColor(mContext.getResources().getColor(afterTextColor));
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (length < 0) {
                ...
                CountdownButton.this.setTextColor(mContext.getResources().getColor(beforeTextColor));
                clearTimer();
                length = 60 * 1000;
            }
        }
