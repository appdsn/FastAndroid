...
import com.appdsn.commoncore.widget.banner.transformer.BannerPageTransformer;
import com.appdsn.commoncore.widget.banner.transformer.TransitionEffect;
...
public class Banner extends RelativeLayout implements BannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private BannerOnNoDoubleClickListener mGuideOnNoDoubleClickListener = new BannerOnNoDoubleClickListener() {
        @Override
    ...
    private class PageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (mDelegate != null) {
                view.setOnClickListener(new BannerOnNoDoubleClickListener() {
                    @Override
    ...
    /**
     * item 点击事件监听器，在 Banner 里已经帮开发者处理了防止重复点击事件
     *
    ...
    /**
     * 引导页「进入」和「跳过」按钮点击事件监听器，在 Banner 里已经帮开发者处理了防止重复点击事件
     */
