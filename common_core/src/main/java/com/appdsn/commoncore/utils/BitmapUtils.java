...
public class BitmapUtils {
     ...
     *
     * @param data      The data.
     * @param offset    offset into imageData for where the decoder should beginparsing.
     * @param maxWidth  The maximum width.
     * @param maxHeight The maximum height.
     * @return bitmap
     */
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId, final int maxWidth, final int maxHeight) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        final Resources resources = ContextUtils.getContext().getResources();
        options.inJustDecodeBounds = true;
     ...
     * @return the bitmap with the specified color
     */
    public static Bitmap drawColor(final Bitmap src, @ColorInt final int color) {
     ...
     * @return the bitmap with the specified color
     */
    public static Bitmap drawColor(final Bitmap src,
     ...
     * @param height  The number of rows width, height values are not
     *                outside of the dimensions of the source bitmap, or width is <= 0,or height is <= 0
     * @param recycle True to recycle the source of bitmap, false otherwise.
     * @return the clipped bitmap
     */
    public static Bitmap clip(final Bitmap src,
     ...
     * @return the round bitmap
     */
    public static Bitmap toCircle(final Bitmap src) {
     ...
     * @return the round bitmap
     */
    public static Bitmap toCircle(final Bitmap src, final boolean recycle) {
     ...
     */
    public static Bitmap compressByScale(final Bitmap src, final int maxWidth, final int maxHeight) {
        if (src == null) {
            return null;
        }
        int width = src.getWidth();
        ...
        float screenRatio = (float) maxWidth / maxHeight;
        ...
        return scale(src, width, height, false);
    }
     ...
     * @return the compressed bitmap
     */
    public static Bitmap compressByScale(final Bitmap src, final float scale) {
        return scale(src, scale, scale, false);
    }
