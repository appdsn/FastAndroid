    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (TextUtils.isEmpty(crashDirPath)) {
            if (FileUtils.isSDCardEnable()
                    && ContextUtils.getContext().getExternalFilesDir(null) != null) {
                dirPath = ContextUtils.getContext().getExternalFilesDir(null) + FILE_SEP + "crash" + FILE_SEP;
            } else {
                dirPath = ContextUtils.getContext().getFilesDir() + FILE_SEP + "crash" + FILE_SEP;
            }
        } else {
        ...
        return new UncaughtExceptionHandler() {
            ...
            public void uncaughtException(@NonNull final Thread t, @NonNull final Throwable e) {
                ...
                final String head = "************* Log Head ****************" +
                        ...
                        "\nApp VersionName    : " + AppUtils.getVersionName() +
                        "\nApp VersionCode    : " + AppUtils.getVersionCode() +
                        "\n************* Log Head ****************\n\n";
                ...
                FileUtils.writeTextToFile(crashInfo, crashFile);
