...
public final class ActivityLifecycleImpl implements Application.ActivityLifecycleCallbacks {
    ...
    private final List<AppUtils.OnAppStatusChangedListener> mStatusListeners = new ArrayList<>();
    private final Map<Activity, List<ActivityUtils.ActivityLifecycleCallbacks>> mActivityLifecycleCallbacksMap = new ConcurrentHashMap<>();
    ...
    void addActivityLifecycleCallbacks(final Activity activity,
                                       final ActivityUtils.ActivityLifecycleCallbacks listener) {
    ...
    private void addActivityLifecycleCallbacksInner(final Activity activity,
                                                    final ActivityUtils.ActivityLifecycleCallbacks lifecycleCallbacks) {
        List<ActivityUtils.ActivityLifecycleCallbacks> callbacks = mActivityLifecycleCallbacksMap.get(activity);
        if (callbacks == null) {
    ...
    private void consumeActivityLifecycleCallbacks(Activity activity, Lifecycle.Event event) {
        List<ActivityUtils.ActivityLifecycleCallbacks> listeners = mActivityLifecycleCallbacksMap.get(activity);
        if (listeners != null) {
            for (ActivityUtils.ActivityLifecycleCallbacks listener : listeners) {
    ...
    private Object getActivityThreadInLoadedApkField() {
        try {
            ...
            Object mLoadedApk = mLoadedApkField.get(ContextUtils.getContext());
