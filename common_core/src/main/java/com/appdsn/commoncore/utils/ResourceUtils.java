...
/**
 * Desc:资源名称转资源ID，获取Assets资源，获取Raw资源，
 *
 * @Author: wangbaozhong 2019/10/28 10:51
...
public final class ResourceUtils {
    ...
    public static int getIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "id", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "string", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "color", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "dimen", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "drawable", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "mipmap", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "layout", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "style", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "anim", ContextUtils.getContext().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return ContextUtils.getContext().getResources().getIdentifier(name, "menu", ContextUtils.getContext().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = ContextUtils.getContext().getAssets().list(assetsFilePath);
            if (assets.length > 0) {
                ...
                res = writeFileFromIS(
                        destFilePath,
                        ContextUtils.getContext().getAssets().open(assetsFilePath),
                        false
                );
            }
        } catch (IOException e) {
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
            is = ContextUtils.getContext().getAssets().open(assetsFilePath);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return is2List(ContextUtils.getContext().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return writeFileFromIS(
                destFilePath,
                ContextUtils.getContext().getResources().openRawResource(resId),
                false
        );
    }
    ...
    public static String readRaw2String(@RawRes final int resId, final String charsetName) {
        InputStream is = ContextUtils.getContext().getResources().openRawResource(resId);
        byte[] bytes = is2Bytes(is);
        if (bytes == null) {
            return null;
        }
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return is2List(ContextUtils.getContext().getResources().openRawResource(resId), charsetName);
    }
