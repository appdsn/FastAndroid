...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(final File file) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = ContextUtils.getContext().getPackageName() + ".utilcode.provider";
            uri = FileProvider.getUriForFile(ContextUtils.getContext(), authority, file);
        }
    ...
    public static Intent getShareImageIntent(final String content, final File image) {
        ...
        return getShareImageIntent(content, CommonFileProvider.getUriForFile(ContextUtils.getContext(), image));
    }
    ...
    public static Intent getShareImageIntent(final String content, final List<File> images) {
        ...
        for (File image : images) {
            ...
            uris.add(CommonFileProvider.getUriForFile(ContextUtils.getContext(), image));
        }
